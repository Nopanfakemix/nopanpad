function cutter_extrude_500_outline_fn(){
...
.extrude({ offset: [0, 0, 20] });
                ...
                function xsection_case_fn() {
                    

                // creating part 0 of case xsection
                let xsection__part_0 = assembly_case_fn();

                // make sure that rotations are relative
                let xsection__part_0_bounds = xsection__part_0.getBounds();
                let xsection__part_0_x = xsection__part_0_bounds[0].x + (xsection__part_0_bounds[1].x - xsection__part_0_bounds[0].x) / 2
                let xsection__part_0_y = xsection__part_0_bounds[0].y + (xsection__part_0_bounds[1].y - xsection__part_0_bounds[0].y) / 2
                xsection__part_0 = translate([-xsection__part_0_x, -xsection__part_0_y, 0], xsection__part_0);
                xsection__part_0 = rotate([0,0,0], xsection__part_0);
                xsection__part_0 = translate([xsection__part_0_x, xsection__part_0_y, 0], xsection__part_0);

                xsection__part_0 = translate([0,0,0], xsection__part_0);
                let result = xsection__part_0;
                
            

                // creating part 1 of case xsection
                let xsection__part_1 = cutter_extrude_500_outline_fn();

                // make sure that rotations are relative
                let xsection__part_1_bounds = xsection__part_1.getBounds();
                let xsection__part_1_x = xsection__part_1_bounds[0].x + (xsection__part_1_bounds[1].x - xsection__part_1_bounds[0].x) / 2
                let xsection__part_1_y = xsection__part_1_bounds[0].y + (xsection__part_1_bounds[1].y - xsection__part_1_bounds[0].y) / 2
                xsection__part_1 = translate([-xsection__part_1_x, -xsection__part_1_y, 0], xsection__part_1);
                xsection__part_1 = rotate([0,90,0], xsection__part_1);
                xsection__part_1 = translate([xsection__part_1_x, xsection__part_1_y, 0], xsection__part_1);

                xsection__part_1 = translate([15,10,0], xsection__part_1);
                result = result.subtract(xsection__part_1);
